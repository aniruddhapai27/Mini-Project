  ...
  return (
    <div className="h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-gray-800/10 to-black rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 max-h-screen overflow-hidden">
        {/* Hero Section */}
        <div className="text-center max-w-6xl mx-auto px-4 flex flex-col h-screen justify-center">
          {" "}
          {/* Main Title */}
          ...
          <p className="text-base text-black/70 dark:text-white/70 mb-6 max-w-2xl mx-auto">
            Get personalized feedback, practice with real interview questions,
            and boost your confidence with our cutting-edge AI assistant.
          </p>{" "}
          {/* Feature highlights */}
          <div className="grid md:grid-cols-3 gap-4 mb-6 max-w-4xl mx-auto">
            {" "}
            <div className="p-4 rounded-xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 backdrop-blur-sm transition-all duration-300 group hover:scale-105 hover:shadow-xl">
              ...
              <p className="text-black/70 dark:text-white/70 text-sm">
                Advanced AI analyzes your responses and provides instant
                feedback
              </p>
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
            ...
            <div className="text-center p-3 rounded-xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/30 backdrop-blur-sm">
