...
const MockInterview = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative flex flex-col overflow-hidden">
      ...
      {/* Header - Fixed at top */}
      <div className="sticky top-0 z-30 border-b border-cyan-500/20 bg-black/60 backdrop-blur-xl shadow-lg">
      ...
      <div className="relative z-10 flex-1 overflow-y-auto pt-2 pb-4">
        <div className="container mx-auto px-4 py-2 max-w-4xl h-full">
        ...
        {!interviewStarted ? (
          ...
          <div className="flex flex-col space-y-4 w-full h-full">
            {/* Chat Container - Adjusted for better scrolling */}
            <div
              ref={chatContainerRef}
              className="bg-black/20 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 min-h-[300px] max-h-[calc(100vh-280px)] h-auto overflow-y-auto space-y-4 shadow-2xl custom-scrollbar"
            >
            ...
            {/* Input Area */}
            <div className="bg-black/30 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 shadow-2xl flex-shrink-0 mb-2">
              <div className="mb-4">
      ...
      <style jsx>{`
        ...
        /* Add padding to ensure last message is fully visible */
