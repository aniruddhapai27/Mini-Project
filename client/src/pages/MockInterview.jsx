...
const MockInterview = () => {
  ...
  }, [dispatch, sessionId, userResponse, isWaitingForAI, questionCount]);
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      {/* Interview Header */}
      <div className="border-b border-black/10 dark:border-white/10 bg-white dark:bg-black sticky top-0 z-40">
