  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black py-8">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {/* Main Results Card */}
        <div className="bg-gradient-to-br from-cyan-500/10 to-purple-500/10 border border-cyan-500/30 rounded-xl p-8 mb-8 shadow-xl animate-fadeIn">
          <div className="text-center">
            {/* Performance Icon and Score */}
            <div className="text-6xl mb-4">{getPerformanceIcon(score)}</div>
            <div className="text-6xl font-bold mb-2 text-black dark:text-white">
              {score}%
            </div>
