    ...
    builder
      ...
      .addCase(endInterviewSession.fulfilled, (state, action) => {
        ...
        if (state.currentSession) {
          ...
          const xpGain = calculateXPGain(action.payload.finalScore, state.currentSession.difficulty);
          const oldLevel = state.level;
...
export const selectShowStreakAnimation = (state) => state.interview.showStreakAnimation;
export const selectShowLevelUpAnimation = (state) => state.interview.showLevelUpAnimation;
export const selectShowAchievementAnimation = (state) => state.interview.showAchievementAnimation;
...
export const selectRecentInterviews = (state) => state.interview.recentInterviews;
...
export const selectCompletedSessions = (state) => state.interview.completedSessions;
